      ...
      ctx.json(
        {
          ...
          title: "Novo jardineiro",
          date: Date.now(),
          content: "Hoje, dia 25 de março de 2022, é o começo da trajetória do novo colaborador do nosso condomínio, Lineu Silva, jardineiro de 62 anos. Ele possui mais de 20 anos de experiência na área, prometendo revolucionar o mindset relacionado a arborização do nosso lar."
        }
      )
    );
  }),
      ...
      ctx.json(
        {
          key: req.params['id'],
          question: "Como entrar em contato com o síndico?",
          answer: "Para entrar em contato com o síndico, você pode utilizar o botão de WhatsApp, disponível na página de contato.\n Ao selecionar o botão de WhatsApp, você será  redirecionado a página do WhatsApp para conversa com o síndico."
        },
      )
    );
  }),
